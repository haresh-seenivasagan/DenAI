        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav22 bodySmall">Upload Images</span>
              <span className="home-nav32 bodySmall">View Report</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav221 bodySmall">Upload Images</span>
                <span className="home-nav321 bodySmall">View Report</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Get Your Personalized Teeth Report
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Upload your images and describe your teeth for a customized
                    analysis
                  </span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Explore the key features that make our platform unique
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Easily upload 3 images of your teeth for analysis"
              ></FeatureCard>
              <FeatureCard
                heading="Provide Text Input"
                subHeading="Enter details about your dental concerns or issues"
              ></FeatureCard>
              <FeatureCard
                heading="Receive Detailed Report"
                subHeading="Get a comprehensive report with analysis and recommendations"
              ></FeatureCard>
              <FeatureCard
                heading="Easy to Use"
                subHeading="Simple and user-friendly interface for a seamless experience"
              ></FeatureCard>
            </div>
          </div>
        </div>
            ...
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">
                    Upload 3 images of your teeth
                  </span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">
                    Provide text input about your teeth
                  </span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">
                    Receive a detailed report on your teeth condition
                  </span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container14">
                ...
                <div className="home-container18">
                  ...
                  <span className="bodySmall">
                    Save and compare previous reports
                  </span>
                </div>
                <div className="home-container19">
                  <span className="home-text53">✔</span>
                  <span className="bodySmall">
                    Customize your report with additional notes
                  </span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container22">
                ...
                <div className="home-container24">
                  ...
                  <span className="bodySmall">
                    Unlimited image uploads for detailed analysis
                  </span>
                </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Discover insights about your dental health and get
                  recommendations for a brighter smile. Our advanced analysis
                  will provide you with valuable information to enhance your
                  oral care routine.
                </span>
                <span>
                  <span
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container29">
              <Question1
                answer="You can easily upload your images by clicking on the 'Upload Images' button and selecting the files from your device."
                question="How do I upload my images?"
              ></Question1>
              <Question1
                answer="We recommend uploading clear images of your teeth from different angles to provide a comprehensive view for analysis."
                question="What type of images should I upload?"
              ></Question1>
              <Question1
                answer="Unfortunately, once you submit the text input about your teeth, it cannot be edited. Please ensure the information is accurate before proceeding."
                question="Can I edit the text input about my teeth after submission?"
              ></Question1>
              <Question1
                answer="The result report is usually generated within a few minutes after you have submitted your images and text input."
                question="How long does it take to generate the result report?"
              ></Question1>
              <Question1
                answer="The result report is generated based on advanced algorithms and technology. For personalized dental advice, we recommend consulting a professional dentist."
                question="Is the result report generated by a professional dentist?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container30">
            ...
            <nav className="home-nav1">
              <span className="bodySmall">Home</span>
              <span className="home-nav222 bodySmall">Upload Images</span>
              <span className="home-nav322 bodySmall">View Report</span>
